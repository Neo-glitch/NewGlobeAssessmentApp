...
import com.bridge.androidtechnicaltest.pupil.data.datasources.local.ClearedUnsyncedPupilDao
...
@Database(entities = [LocalPupil::class, PupilRemoteKey::class, ClearedUnSyncedPupil::class], version = 1, exportSchema = false)
...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract val clearedUnsyncedPupilDao: ClearedUnsyncedPupilDao
}